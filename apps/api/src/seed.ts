...
async function seed(): Promise<void> {
  ...
  const [atlas, lotus, northStar, makerLab, bloom, quietPod] = await db.insert(resources).values([
    { name: "Atlas Boardroom", description: "Bright boardroom with hybrid meeting setup.", resourceType: "MEETING_ROOM", location: "Bangkok HQ", capacity: 12, timezone: "Asia/Bangkok", createdBy: ownerId },
    { name: "Lotus Focus Room", description: "Quiet room for focused team conversations.", resourceType: "MEETING_ROOM", location: "Bangkok HQ", capacity: 6, timezone: "Asia/Bangkok", createdBy: ownerId },
    { name: "North Star Desk 24", description: "Ergonomic hot desk with a 4K monitor.", resourceType: "DESK", location: "Chiang Mai Hub", capacity: 1, timezone: "Asia/Bangkok", createdBy: ownerId },
    { name: "Maker Lab", description: "Creative studio with prototyping equipment.", resourceType: "STUDIO", location: "Bangkok HQ", capacity: 18, timezone: "Asia/Bangkok", createdBy: ownerId },
    { name: "Bloom Huddle", description: "Small room for quick team syncs.", resourceType: "MEETING_ROOM", location: "Phuket Office", capacity: 4, timezone: "Asia/Bangkok", createdBy: ownerId },
    { name: "Quiet Pod 07", description: "Acoustically isolated focus pod.", resourceType: "DESK", location: "Bangkok HQ", capacity: 1, timezone: "Asia/Bangkok", createdBy: ownerId },
  ]).onConflictDoNothing().returning();
